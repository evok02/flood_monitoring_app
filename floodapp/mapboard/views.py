    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if len(locations) == 2:
                ...
                p_bcg = '/Users/vlasokseniuk/Desktop/FloodMonitor/floodapp/floodapp/static/images/DALL·E 2025-01-06 17.23.08 - A simple and abstract background representing water, featuring a smooth gradient from light orange at the top to deep orange at the bottom, with soft .webp'
